...
namespace App1
{
	[Activity(Label = "Personal_InforActivity", ScreenOrientation = ScreenOrientation.Portrait)]
	public class Personal_InforActivity : Activity
	{
		protected override void OnCreate(Bundle savedInstanceState)
		{
            RequestWindowFeature(WindowFeatures.NoTitle);
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.Personal_Information);
